import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("RRC5Puno");
    const pdos = localStorage.getItem("RRC5Pdos");
    const ptres = localStorage.getItem("RRC5Ptres");
    const pcuatro = localStorage.getItem("RRC5Pcuatro");
    const pcinco = localStorage.getItem("RRC5Pcinco");
    const pseis = localStorage.getItem("RRC5Pseis");
    const psiete = localStorage.getItem("RRC5Psiete");
    const pocho = localStorage.getItem("RRC5Pocho");
    const pnueve = localStorage.getItem("RRC5Pnueve");
    const pdiez = localStorage.getItem("RRC5Pdiez");
    const ponce = localStorage.getItem("RRC5Ponce");
    const pdoce = localStorage.getItem("RRC5Pdoce");
    const ptrece = localStorage.getItem("RRC5Ptrece");
    const pcatorce = localStorage.getItem("RRC5Pcatorce");
    const pquince = localStorage.getItem("RRC5Pquince");
    const pdieciseis = localStorage.getItem("RRC5Pdieciseis");
    const pdiecisiete = localStorage.getItem("RRC5Pdiecisiete");
    const pdieciocho = localStorage.getItem("RRC5Pdieciocho");
    const pdiecinueve = localStorage.getItem("RRC5Pdiecinueve");
    const pveinte = localStorage.getItem("RRC5Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.RRC5Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.RRC5Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.RRC5Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.RRC5Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.RRC5Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.RRC5Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.RRC5Psiete))
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.RRC5Pocho))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.RRC5Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.RRC5Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.RRC5Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.RRC5Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.RRC5Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.RRC5Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.RRC5Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.RRC5Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.RRC5Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.RRC5Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.RRC5Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.RRC5Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.RRC5Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.RRC5Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.RRC5Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.RRC5Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.RRC5Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.RRC5Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.RRC5Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.RRC5Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.RRC5Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.RRC5Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.RRC5Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.RRC5Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.RRC5Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.RRC5Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.RRC5Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.RRC5Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.RRC5Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.RRC5Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.RRC5Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.RRC5Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.RRC5Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.RRC5Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.RRC5Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.RRC5Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.RRC5Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.RRC5Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.RRC5Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.RRC5Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.RRC5Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.RRC5Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.RRC5Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.RRC5Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.RRC5Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.RRC5Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.RRC5Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.RRC5Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.RRC5Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.RRC5Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.RRC5Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.RRC5Pveinte);
