...
$(function () {
    const puno = localStorage.getItem("excep08Puno");
    const pdos = localStorage.getItem("excep08Pdos");
    const ptres = localStorage.getItem("excep08Ptres");
    const pcuatro = localStorage.getItem("excep08Pcuatro");
    const pcinco = localStorage.getItem("excep08Pcinco");
    const pseis = localStorage.getItem("excep08Pseis");
    const psiete = localStorage.getItem("excep08Psiete");
    const pocho = localStorage.getItem("excep08Pocho");
    const pnueve = localStorage.getItem("excep08Pnueve");
    const pdiez = localStorage.getItem("excep08Pdiez");
    const ponce = localStorage.getItem("excep08Ponce");
    const pdoce = localStorage.getItem("excep08Pdoce");
    const ptrece = localStorage.getItem("excep08Ptrece");
    const pcatorce = localStorage.getItem("excep08Pcatorce");
    const pquince = localStorage.getItem("excep08Pquince");
    const pdieciseis = localStorage.getItem("excep08Pdieciseis");
    const pdiecisiete = localStorage.getItem("excep08Pdiecisiete");
    const pdieciocho = localStorage.getItem("excep08Pdieciocho");
    const pdiecinueve = localStorage.getItem("excep08Pdiecinueve");
    const pveinte = localStorage.getItem("excep08Pveinte");
    const pveintiuno = localStorage.getItem("excep08Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.excep08Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.excep08Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.excep08Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.excep08Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.excep08Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.excep08Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.excep08Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.excep08Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.excep08Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.excep08Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.excep08Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.excep08Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.excep08Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.excep08Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.excep08Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.excep08Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.excep08Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.excep08Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.excep08Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.excep08Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.excep08Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.excep08Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.excep08Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.excep08Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.excep08Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.excep08Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.excep08Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.excep08Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.excep08Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.excep08Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.excep08Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.excep08Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.excep08Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.excep08Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.excep08Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.excep08Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.excep08Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.excep08Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.excep08Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.excep08Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.excep08Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.excep08Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.excep08Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.excep08Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.excep08Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.excep08Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.excep08Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.excep08Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.excep08Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.excep08Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.excep08Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.excep08Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.excep08Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.excep08Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.excep08Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.excep08Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.excep08Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.excep08Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.excep08Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.excep08Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.excep08Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.excep08Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.excep08Pveintiuno);
