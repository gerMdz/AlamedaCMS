...
$(function () {
    const puno = localStorage.getItem("calma04Puno");
    const pdos = localStorage.getItem("calma04Pdos");
    const ptres = localStorage.getItem("calma04Ptres");
    const pcuatro = localStorage.getItem("calma04Pcuatro");
    const pcinco = localStorage.getItem("calma04Pcinco");
    const pseis = localStorage.getItem("calma04Pseis");
    const psiete = localStorage.getItem("calma04Psiete");
    const pocho = localStorage.getItem("calma04Pocho");
    const pnueve = localStorage.getItem("calma04Pnueve");
    const pdiez = localStorage.getItem("calma04Pdiez");
    const ponce = localStorage.getItem("calma04Ponce");
    const pdoce = localStorage.getItem("calma04Pdoce");
    const ptrece = localStorage.getItem("calma04Ptrece");
    const pcatorce = localStorage.getItem("calma04Pcatorce");
    const pquince = localStorage.getItem("calma04Pquince");
    const pdieciseis = localStorage.getItem("calma04Pdieciseis");
    const pdiecisiete = localStorage.getItem("calma04Pdiecisiete");
    const pdieciocho = localStorage.getItem("calma04Pdieciocho");
    const pdiecinueve = localStorage.getItem("calma04Pdiecinueve");
    const pveinte = localStorage.getItem("calma04Pveinte");
    const pveintiuno = localStorage.getItem("calma04Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.calma04Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.calma04Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.calma04Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.calma04Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.calma04Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.calma04Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.calma04Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.calma04Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.calma04Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.calma04Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.calma04Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.calma04Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.calma04Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.calma04Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.calma04Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.calma04Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.calma04Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.calma04Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.calma04Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.calma04Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.calma04Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.calma04Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.calma04Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.calma04Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.calma04Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.calma04Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.calma04Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.calma04Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.calma04Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.calma04Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.calma04Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.calma04Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.calma04Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.calma04Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.calma04Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.calma04Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.calma04Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.calma04Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.calma04Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.calma04Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.calma04Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.calma04Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.calma04Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.calma04Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.calma04Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.calma04Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.calma04Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.calma04Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.calma04Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.calma04Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.calma04Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.calma04Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.calma04Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.calma04Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.calma04Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.calma04Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.calma04Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.calma04Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.calma04Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.calma04Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.calma04Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.calma04Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.calma04Pveintiuno);
