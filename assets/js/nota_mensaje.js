...
$(function () {
    const puno = localStorage.getItem("cde05Puno");
    const pdos = localStorage.getItem("cde05Pdos");
    const ptres = localStorage.getItem("cde05Ptres");
    const pcuatro = localStorage.getItem("cde05Pcuatro");
    const pcinco = localStorage.getItem("cde05Pcinco");
    const pseis = localStorage.getItem("cde05Pseis");
    const psiete = localStorage.getItem("cde05Psiete");
    const pocho = localStorage.getItem("cde05Pocho");
    const pnueve = localStorage.getItem("cde05Pnueve");
    const pdiez = localStorage.getItem("cde05Pdiez");
    const ponce = localStorage.getItem("cde05Ponce");
    const pdoce = localStorage.getItem("cde05Pdoce");
    const ptrece = localStorage.getItem("cde05Ptrece");
    const pcatorce = localStorage.getItem("cde05Pcatorce");
    const pquince = localStorage.getItem("cde05Pquince");
    const pdieciseis = localStorage.getItem("cde05Pdieciseis");
    const pdiecisiete = localStorage.getItem("cde05Pdiecisiete");
    const pdieciocho = localStorage.getItem("cde05Pdieciocho");
    const pdiecinueve = localStorage.getItem("cde05Pdiecinueve");
    const pveinte = localStorage.getItem("cde05Pveinte");
    const pveintiuno = localStorage.getItem("cde05Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.cde05Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.cde05Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.cde05Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.cde05Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.cde05Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.cde05Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.cde05Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.cde05Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.cde05Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.cde05Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.cde05Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.cde05Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.cde05Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.cde05Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.cde05Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.cde05Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.cde05Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.cde05Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.cde05Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.cde05Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.cde05Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.cde05Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.cde05Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.cde05Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.cde05Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.cde05Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.cde05Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.cde05Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.cde05Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.cde05Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.cde05Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.cde05Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.cde05Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.cde05Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.cde05Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.cde05Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.cde05Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.cde05Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.cde05Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.cde05Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.cde05Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.cde05Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.cde05Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.cde05Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.cde05Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.cde05Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.cde05Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.cde05Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.cde05Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.cde05Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.cde05Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.cde05Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.cde05Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.cde05Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.cde05Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.cde05Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.cde05Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.cde05Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.cde05Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.cde05Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.cde05Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.cde05Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.cde05Pveintiuno);
