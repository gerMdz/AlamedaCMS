import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("detox03Puno");
    const pdos = localStorage.getItem("detox03Pdos");
    const ptres = localStorage.getItem("detox03Ptres");
    const pcuatro = localStorage.getItem("detox03Pcuatro");
    const pcinco = localStorage.getItem("detox03Pcinco");
    const pseis = localStorage.getItem("detox03Pseis");
    const psiete = localStorage.getItem("detox03Psiete");
    const pocho = localStorage.getItem("detox03Pocho");
    const pnueve = localStorage.getItem("detox03Pnueve");
    const pdiez = localStorage.getItem("detox03Pdiez");
    const ponce = localStorage.getItem("detox03Ponce");
    const pdoce = localStorage.getItem("detox03Pdoce");
    const ptrece = localStorage.getItem("detox03Ptrece");
    const pcatorce = localStorage.getItem("detox03Pcatorce");
    const pquince = localStorage.getItem("detox03Pquince");
    const pdieciseis = localStorage.getItem("detox03Pdieciseis");
    const pdiecisiete = localStorage.getItem("detox03Pdiecisiete");
    const pdieciocho = localStorage.getItem("detox03Pdieciocho");
    const pdiecinueve = localStorage.getItem("detox03Pdiecinueve");
    const pveinte = localStorage.getItem("detox03Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.detox03Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.detox03Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.detox03Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.detox03Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.detox03Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.detox03Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.detox03Psiete))
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.detox03Pocho))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.detox03Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.detox03Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.detox03Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.detox03Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.detox03Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.detox03Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.detox03Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.detox03Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.detox03Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.detox03Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.detox03Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.detox03Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.detox03Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.detox03Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.detox03Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.detox03Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.detox03Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.detox03Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.detox03Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.detox03Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.detox03Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.detox03Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.detox03Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.detox03Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.detox03Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.detox03Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.detox03Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.detox03Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.detox03Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.detox03Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.detox03Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.detox03Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.detox03Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.detox03Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.detox03Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.detox03Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.detox03Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.detox03Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.detox03Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.detox03Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.detox03Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.detox03Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.detox03Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.detox03Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.detox03Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.detox03Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.detox03Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.detox03Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.detox03Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.detox03Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.detox03Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.detox03Pveinte);
