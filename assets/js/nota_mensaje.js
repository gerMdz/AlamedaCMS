...
$(function () {
    const puno = localStorage.getItem("sos06Puno");
    const pdos = localStorage.getItem("sos06Pdos");
    const ptres = localStorage.getItem("sos06Ptres");
    const pcuatro = localStorage.getItem("sos06Pcuatro");
    const pcinco = localStorage.getItem("sos06Pcinco");
    const pseis = localStorage.getItem("sos06Pseis");
    const psiete = localStorage.getItem("sos06Psiete");
    const pocho = localStorage.getItem("sos06Pocho");
    const pnueve = localStorage.getItem("sos06Pnueve");
    const pdiez = localStorage.getItem("sos06Pdiez");
    const ponce = localStorage.getItem("sos06Ponce");
    const pdoce = localStorage.getItem("sos06Pdoce");
    const ptrece = localStorage.getItem("sos06Ptrece");
    const pcatorce = localStorage.getItem("sos06Pcatorce");
    const pquince = localStorage.getItem("sos06Pquince");
    const pdieciseis = localStorage.getItem("sos06Pdieciseis");
    const pdiecisiete = localStorage.getItem("sos06Pdiecisiete");
    const pdieciocho = localStorage.getItem("sos06Pdieciocho");
    const pdiecinueve = localStorage.getItem("sos06Pdiecinueve");
    const pveinte = localStorage.getItem("sos06Pveinte");
    const pveintiuno = localStorage.getItem("sos06Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.sos06Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.sos06Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.sos06Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.sos06Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.sos06Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.sos06Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.sos06Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.sos06Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.sos06Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.sos06Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.sos06Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.sos06Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.sos06Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.sos06Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.sos06Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.sos06Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.sos06Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.sos06Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.sos06Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.sos06Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.sos06Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.sos06Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.sos06Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.sos06Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.sos06Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.sos06Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.sos06Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.sos06Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.sos06Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.sos06Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.sos06Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.sos06Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.sos06Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.sos06Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.sos06Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.sos06Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.sos06Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.sos06Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.sos06Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.sos06Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.sos06Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.sos06Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.sos06Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.sos06Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.sos06Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.sos06Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.sos06Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.sos06Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.sos06Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.sos06Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.sos06Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.sos06Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.sos06Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.sos06Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.sos06Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.sos06Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.sos06Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.sos06Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.sos06Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.sos06Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.sos06Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.sos06Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.sos06Pveintiuno);
