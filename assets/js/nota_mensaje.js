...
$(function () {
    const puno = localStorage.getItem("sos05Puno");
    const pdos = localStorage.getItem("sos05Pdos");
    const ptres = localStorage.getItem("sos05Ptres");
    const pcuatro = localStorage.getItem("sos05Pcuatro");
    const pcinco = localStorage.getItem("sos05Pcinco");
    const pseis = localStorage.getItem("sos05Pseis");
    const psiete = localStorage.getItem("sos05Psiete");
    const pocho = localStorage.getItem("sos05Pocho");
    const pnueve = localStorage.getItem("sos05Pnueve");
    const pdiez = localStorage.getItem("sos05Pdiez");
    const ponce = localStorage.getItem("sos05Ponce");
    const pdoce = localStorage.getItem("sos05Pdoce");
    const ptrece = localStorage.getItem("sos05Ptrece");
    const pcatorce = localStorage.getItem("sos05Pcatorce");
    const pquince = localStorage.getItem("sos05Pquince");
    const pdieciseis = localStorage.getItem("sos05Pdieciseis");
    const pdiecisiete = localStorage.getItem("sos05Pdiecisiete");
    const pdieciocho = localStorage.getItem("sos05Pdieciocho");
    const pdiecinueve = localStorage.getItem("sos05Pdiecinueve");
    const pveinte = localStorage.getItem("sos05Pveinte");
    const pveintiuno = localStorage.getItem("sos05Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.sos05Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.sos05Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.sos05Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.sos05Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.sos05Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.sos05Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.sos05Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.sos05Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.sos05Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.sos05Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.sos05Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.sos05Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.sos05Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.sos05Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.sos05Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.sos05Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.sos05Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.sos05Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.sos05Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.sos05Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.sos05Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.sos05Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.sos05Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.sos05Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.sos05Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.sos05Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.sos05Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.sos05Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.sos05Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.sos05Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.sos05Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.sos05Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.sos05Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.sos05Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.sos05Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.sos05Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.sos05Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.sos05Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.sos05Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.sos05Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.sos05Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.sos05Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.sos05Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.sos05Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.sos05Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.sos05Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.sos05Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.sos05Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.sos05Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.sos05Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.sos05Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.sos05Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.sos05Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.sos05Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.sos05Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.sos05Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.sos05Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.sos05Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.sos05Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.sos05Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.sos05Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.sos05Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.sos05Pveintiuno);
