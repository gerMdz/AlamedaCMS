...
$(function () {
    const puno = localStorage.getItem("calma03Puno");
    const pdos = localStorage.getItem("calma03Pdos");
    const ptres = localStorage.getItem("calma03Ptres");
    const pcuatro = localStorage.getItem("calma03Pcuatro");
    const pcinco = localStorage.getItem("calma03Pcinco");
    const pseis = localStorage.getItem("calma03Pseis");
    const psiete = localStorage.getItem("calma03Psiete");
    const pocho = localStorage.getItem("calma03Pocho");
    const pnueve = localStorage.getItem("calma03Pnueve");
    const pdiez = localStorage.getItem("calma03Pdiez");
    const ponce = localStorage.getItem("calma03Ponce");
    const pdoce = localStorage.getItem("calma03Pdoce");
    const ptrece = localStorage.getItem("calma03Ptrece");
    const pcatorce = localStorage.getItem("calma03Pcatorce");
    const pquince = localStorage.getItem("calma03Pquince");
    const pdieciseis = localStorage.getItem("calma03Pdieciseis");
    const pdiecisiete = localStorage.getItem("calma03Pdiecisiete");
    const pdieciocho = localStorage.getItem("calma03Pdieciocho");
    const pdiecinueve = localStorage.getItem("calma03Pdiecinueve");
    const pveinte = localStorage.getItem("calma03Pveinte");
    const pveintiuno = localStorage.getItem("calma03Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.calma03Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.calma03Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.calma03Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.calma03Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.calma03Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.calma03Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.calma03Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.calma03Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.calma03Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.calma03Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.calma03Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.calma03Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.calma03Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.calma03Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.calma03Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.calma03Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.calma03Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.calma03Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.calma03Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.calma03Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.calma03Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.calma03Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.calma03Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.calma03Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.calma03Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.calma03Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.calma03Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.calma03Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.calma03Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.calma03Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.calma03Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.calma03Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.calma03Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.calma03Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.calma03Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.calma03Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.calma03Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.calma03Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.calma03Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.calma03Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.calma03Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.calma03Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.calma03Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.calma03Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.calma03Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.calma03Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.calma03Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.calma03Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.calma03Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.calma03Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.calma03Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.calma03Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.calma03Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.calma03Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.calma03Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.calma03Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.calma03Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.calma03Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.calma03Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.calma03Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.calma03Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.calma03Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.calma03Pveintiuno);
