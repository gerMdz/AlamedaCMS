...
$(function () {
    const puno = localStorage.getItem("rocar01Puno");
    const pdos = localStorage.getItem("rocar01Pdos");
    const ptres = localStorage.getItem("rocar01Ptres");
    const pcuatro = localStorage.getItem("rocar01Pcuatro");
    const pcinco = localStorage.getItem("rocar01Pcinco");
    const pseis = localStorage.getItem("rocar01Pseis");
    const psiete = localStorage.getItem("rocar01Psiete");
    const pocho = localStorage.getItem("rocar01Pocho");
    const pnueve = localStorage.getItem("rocar01Pnueve");
    const pdiez = localStorage.getItem("rocar01Pdiez");
    const ponce = localStorage.getItem("rocar01Ponce");
    const pdoce = localStorage.getItem("rocar01Pdoce");
    const ptrece = localStorage.getItem("rocar01Ptrece");
    const pcatorce = localStorage.getItem("rocar01Pcatorce");
    const pquince = localStorage.getItem("rocar01Pquince");
    const pdieciseis = localStorage.getItem("rocar01Pdieciseis");
    const pdiecisiete = localStorage.getItem("rocar01Pdiecisiete");
    const pdieciocho = localStorage.getItem("rocar01Pdieciocho");
    const pdiecinueve = localStorage.getItem("rocar01Pdiecinueve");
    const pveinte = localStorage.getItem("rocar01Pveinte");
    const pveintiuno = localStorage.getItem("rocar01Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.rocar01Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.rocar01Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.rocar01Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.rocar01Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.rocar01Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.rocar01Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.rocar01Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.rocar01Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.rocar01Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.rocar01Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.rocar01Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.rocar01Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.rocar01Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.rocar01Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.rocar01Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.rocar01Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.rocar01Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.rocar01Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.rocar01Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.rocar01Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.rocar01Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.rocar01Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.rocar01Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.rocar01Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.rocar01Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.rocar01Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.rocar01Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.rocar01Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.rocar01Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.rocar01Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.rocar01Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.rocar01Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.rocar01Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.rocar01Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.rocar01Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.rocar01Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.rocar01Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.rocar01Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.rocar01Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.rocar01Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.rocar01Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.rocar01Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.rocar01Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.rocar01Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.rocar01Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.rocar01Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.rocar01Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.rocar01Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.rocar01Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.rocar01Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.rocar01Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.rocar01Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.rocar01Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.rocar01Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.rocar01Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.rocar01Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.rocar01Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.rocar01Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.rocar01Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.rocar01Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.rocar01Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.rocar01Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.rocar01Pveintiuno);
