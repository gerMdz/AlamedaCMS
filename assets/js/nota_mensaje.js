...
$(function () {
    const puno = localStorage.getItem("cde04Puno");
    const pdos = localStorage.getItem("cde04Pdos");
    const ptres = localStorage.getItem("cde04Ptres");
    const pcuatro = localStorage.getItem("cde04Pcuatro");
    const pcinco = localStorage.getItem("cde04Pcinco");
    const pseis = localStorage.getItem("cde04Pseis");
    const psiete = localStorage.getItem("cde04Psiete");
    const pocho = localStorage.getItem("cde04Pocho");
    const pnueve = localStorage.getItem("cde04Pnueve");
    const pdiez = localStorage.getItem("cde04Pdiez");
    const ponce = localStorage.getItem("cde04Ponce");
    const pdoce = localStorage.getItem("cde04Pdoce");
    const ptrece = localStorage.getItem("cde04Ptrece");
    const pcatorce = localStorage.getItem("cde04Pcatorce");
    const pquince = localStorage.getItem("cde04Pquince");
    const pdieciseis = localStorage.getItem("cde04Pdieciseis");
    const pdiecisiete = localStorage.getItem("cde04Pdiecisiete");
    const pdieciocho = localStorage.getItem("cde04Pdieciocho");
    const pdiecinueve = localStorage.getItem("cde04Pdiecinueve");
    const pveinte = localStorage.getItem("cde04Pveinte");
    const pveintiuno = localStorage.getItem("cde04Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.cde04Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.cde04Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.cde04Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.cde04Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.cde04Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.cde04Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.cde04Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.cde04Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.cde04Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.cde04Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.cde04Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.cde04Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.cde04Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.cde04Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.cde04Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.cde04Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.cde04Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.cde04Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.cde04Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.cde04Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.cde04Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.cde04Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.cde04Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.cde04Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.cde04Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.cde04Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.cde04Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.cde04Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.cde04Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.cde04Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.cde04Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.cde04Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.cde04Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.cde04Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.cde04Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.cde04Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.cde04Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.cde04Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.cde04Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.cde04Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.cde04Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.cde04Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.cde04Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.cde04Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.cde04Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.cde04Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.cde04Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.cde04Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.cde04Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.cde04Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.cde04Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.cde04Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.cde04Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.cde04Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.cde04Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.cde04Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.cde04Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.cde04Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.cde04Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.cde04Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.cde04Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.cde04Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.cde04Pveintiuno);
