import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("Cree6Puno");
    const pdos = localStorage.getItem("Cree6Pdos");
    const ptres = localStorage.getItem("Cree6Ptres");
    const pcuatro = localStorage.getItem("Cree6Pcuatro");
    const pcinco = localStorage.getItem("Cree6Pcinco");
    const pseis = localStorage.getItem("Cree6Pseis");
    const psiete = localStorage.getItem("Cree6Psiete");
    const pocho = localStorage.getItem("Cree6Pocho");
    const pnueve = localStorage.getItem("Cree6Pnueve");
    const pdiez = localStorage.getItem("Cree6Pdiez");
    const ponce = localStorage.getItem("Cree6Ponce");
    const pdoce = localStorage.getItem("Cree6Pdoce");
    const ptrece = localStorage.getItem("Cree6Ptrece");
    const pcatorce = localStorage.getItem("Cree6Pcatorce");
    const pquince = localStorage.getItem("Cree6Pquince");
    const pdieciseis = localStorage.getItem("Cree6Pdieciseis");
    const pdiecisiete = localStorage.getItem("Cree6Pdiecisiete");
    const pdieciocho = localStorage.getItem("Cree6Pdieciocho");
    const pdiecinueve = localStorage.getItem("Cree6Pdiecinueve");
    const pveinte = localStorage.getItem("Cree6Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.Cree6Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.Cree6Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.Cree6Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.Cree6Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.Cree6Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.Cree6Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.Cree6Psiete))
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.Cree6Pocho))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.Cree6Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.Cree6Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.Cree6Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.Cree6Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.Cree6Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.Cree6Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.Cree6Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.Cree6Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.Cree6Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.Cree6Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.Cree6Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.Cree6Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.Cree6Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.Cree6Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.Cree6Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.Cree6Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.Cree6Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.Cree6Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.Cree6Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.Cree6Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.Cree6Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.Cree6Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.Cree6Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.Cree6Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.Cree6Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.Cree6Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.Cree6Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.Cree6Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.Cree6Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.Cree6Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.Cree6Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.Cree6Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.Cree6Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.Cree6Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.Cree6Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.Cree6Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.Cree6Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.Cree6Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.Cree6Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.Cree6Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.Cree6Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.Cree6Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.Cree6Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.Cree6Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.Cree6Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.Cree6Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.Cree6Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.Cree6Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.Cree6Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.Cree6Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.Cree6Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.Cree6Pveinte);
