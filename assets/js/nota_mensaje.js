...
$(function () {
    const puno = localStorage.getItem("excep03Puno");
    const pdos = localStorage.getItem("excep03Pdos");
    const ptres = localStorage.getItem("excep03Ptres");
    const pcuatro = localStorage.getItem("excep03Pcuatro");
    const pcinco = localStorage.getItem("excep03Pcinco");
    const pseis = localStorage.getItem("excep03Pseis");
    const psiete = localStorage.getItem("excep03Psiete");
    const pocho = localStorage.getItem("excep03Pocho");
    const pnueve = localStorage.getItem("excep03Pnueve");
    const pdiez = localStorage.getItem("excep03Pdiez");
    const ponce = localStorage.getItem("excep03Ponce");
    const pdoce = localStorage.getItem("excep03Pdoce");
    const ptrece = localStorage.getItem("excep03Ptrece");
    const pcatorce = localStorage.getItem("excep03Pcatorce");
    const pquince = localStorage.getItem("excep03Pquince");
    const pdieciseis = localStorage.getItem("excep03Pdieciseis");
    const pdiecisiete = localStorage.getItem("excep03Pdiecisiete");
    const pdieciocho = localStorage.getItem("excep03Pdieciocho");
    const pdiecinueve = localStorage.getItem("excep03Pdiecinueve");
    const pveinte = localStorage.getItem("excep03Pveinte");
    const pveintiuno = localStorage.getItem("excep03Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.excep03Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.excep03Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.excep03Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.excep03Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.excep03Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.excep03Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.excep03Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.excep03Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.excep03Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.excep03Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.excep03Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.excep03Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.excep03Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.excep03Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.excep03Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.excep03Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.excep03Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.excep03Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.excep03Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.excep03Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.excep03Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.excep03Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.excep03Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.excep03Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.excep03Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.excep03Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.excep03Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.excep03Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.excep03Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.excep03Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.excep03Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.excep03Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.excep03Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.excep03Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.excep03Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.excep03Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.excep03Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.excep03Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.excep03Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.excep03Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.excep03Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.excep03Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.excep03Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.excep03Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.excep03Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.excep03Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.excep03Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.excep03Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.excep03Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.excep03Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.excep03Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.excep03Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.excep03Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.excep03Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.excep03Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.excep03Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.excep03Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.excep03Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.excep03Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.excep03Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.excep03Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.excep03Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.excep03Pveintiuno);
