import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("SE5Puno");
    const pdos = localStorage.getItem("SE5Pdos");
    const ptres = localStorage.getItem("SE5Ptres");
    const pcuatro = localStorage.getItem("SE5Pcuatro");
    const pcinco = localStorage.getItem("SE5Pcinco");
    const pseis = localStorage.getItem("SE5Pseis");
    const psiete = localStorage.getItem("SE5Psiete");
    const pocho = localStorage.getItem("SE5Pocho");
    const pnueve = localStorage.getItem("SE5Pnueve");
    const pdiez = localStorage.getItem("SE5Pdiez");
    const ponce = localStorage.getItem("SE5Ponce");
    const pdoce = localStorage.getItem("SE5Pdoce");
    const ptrece = localStorage.getItem("SE5Ptrece");
    const pcatorce = localStorage.getItem("SE5Pcatorce");
    const pquince = localStorage.getItem("SE5Pquince");
    const pdieciseis = localStorage.getItem("SE5Pdieciseis");
    const pdiecisiete = localStorage.getItem("SE5Pdiecisiete");
    const pdieciocho = localStorage.getItem("SE5Pdieciocho");
    const pdiecinueve = localStorage.getItem("SE5Pdiecinueve");
    const pveinte = localStorage.getItem("SE5Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.SE5Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.SE5Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.SE5Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.SE5Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.SE5Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.SE5Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.SE5Psiete))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.SE5Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.SE5Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.SE5Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.SE5Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.SE5Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.SE5Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.SE5Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.SE5Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.SE5Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.SE5Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.SE5Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.SE5Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.SE5Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.SE5Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.SE5Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.SE5Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.SE5Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.SE5Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.SE5Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.SE5Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.SE5Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.SE5Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.SE5Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.SE5Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.SE5Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.SE5Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.SE5Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.SE5Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.SE5Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.SE5Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.SE5Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.SE5Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.SE5Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.SE5Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.SE5Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.SE5Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.SE5Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.SE5Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.SE5Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.SE5Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.SE5Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.SE5Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.SE5Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.SE5Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.SE5Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.SE5Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.SE5Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.SE5Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.SE5Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.SE5Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.SE5Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.SE5Pveinte);
