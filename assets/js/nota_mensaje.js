...
$(function () {
    const puno = localStorage.getItem("excep04Puno");
    const pdos = localStorage.getItem("excep04Pdos");
    const ptres = localStorage.getItem("excep04Ptres");
    const pcuatro = localStorage.getItem("excep04Pcuatro");
    const pcinco = localStorage.getItem("excep04Pcinco");
    const pseis = localStorage.getItem("excep04Pseis");
    const psiete = localStorage.getItem("excep04Psiete");
    const pocho = localStorage.getItem("excep04Pocho");
    const pnueve = localStorage.getItem("excep04Pnueve");
    const pdiez = localStorage.getItem("excep04Pdiez");
    const ponce = localStorage.getItem("excep04Ponce");
    const pdoce = localStorage.getItem("excep04Pdoce");
    const ptrece = localStorage.getItem("excep04Ptrece");
    const pcatorce = localStorage.getItem("excep04Pcatorce");
    const pquince = localStorage.getItem("excep04Pquince");
    const pdieciseis = localStorage.getItem("excep04Pdieciseis");
    const pdiecisiete = localStorage.getItem("excep04Pdiecisiete");
    const pdieciocho = localStorage.getItem("excep04Pdieciocho");
    const pdiecinueve = localStorage.getItem("excep04Pdiecinueve");
    const pveinte = localStorage.getItem("excep04Pveinte");
    const pveintiuno = localStorage.getItem("excep04Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.excep04Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.excep04Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.excep04Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.excep04Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.excep04Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.excep04Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.excep04Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.excep04Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.excep04Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.excep04Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.excep04Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.excep04Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.excep04Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.excep04Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.excep04Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.excep04Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.excep04Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.excep04Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.excep04Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.excep04Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.excep04Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.excep04Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.excep04Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.excep04Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.excep04Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.excep04Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.excep04Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.excep04Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.excep04Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.excep04Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.excep04Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.excep04Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.excep04Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.excep04Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.excep04Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.excep04Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.excep04Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.excep04Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.excep04Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.excep04Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.excep04Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.excep04Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.excep04Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.excep04Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.excep04Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.excep04Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.excep04Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.excep04Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.excep04Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.excep04Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.excep04Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.excep04Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.excep04Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.excep04Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.excep04Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.excep04Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.excep04Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.excep04Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.excep04Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.excep04Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.excep04Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.excep04Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.excep04Pveintiuno);
