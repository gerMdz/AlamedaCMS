import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("O3Puno");
    const pdos = localStorage.getItem("O3Pdos");
    const ptres = localStorage.getItem("O3Ptres");
    const pcuatro = localStorage.getItem("O3Pcuatro");
    const pcinco = localStorage.getItem("O3Pcinco");
    const pseis = localStorage.getItem("O3Pseis");
    const psiete = localStorage.getItem("O3Psiete");
    const pocho = localStorage.getItem("O3Pocho");
    const pnueve = localStorage.getItem("O3Pnueve");
    const pdiez = localStorage.getItem("O3Pdiez");
    const ponce = localStorage.getItem("O3Ponce");
    const pdoce = localStorage.getItem("O3Pdoce");
    const ptrece = localStorage.getItem("O3Ptrece");
    const pcatorce = localStorage.getItem("O3Pcatorce");
    const pquince = localStorage.getItem("O3Pquince");
    const pdieciseis = localStorage.getItem("O3Pdieciseis");
    const pdiecisiete = localStorage.getItem("O3Pdiecisiete");
    const pdieciocho = localStorage.getItem("O3Pdieciocho");
    const pdiecinueve = localStorage.getItem("O3Pdiecinueve");
    const pveinte = localStorage.getItem("O3Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.O3Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.O3Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.O3Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.O3Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.O3Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.O3Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.O3Psiete))
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.O3Pocho))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.O3Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.O3Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.O3Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.O3Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.O3Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.O3Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.O3Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.O3Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.O3Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.O3Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.O3Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.O3Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.O3Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.O3Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.O3Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.O3Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.O3Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.O3Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.O3Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.O3Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.O3Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.O3Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.O3Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.O3Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.O3Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.O3Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.O3Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.O3Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.O3Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.O3Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.O3Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.O3Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.O3Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.O3Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.O3Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.O3Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.O3Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.O3Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.O3Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.O3Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.O3Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.O3Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.O3Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.O3Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.O3Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.O3Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.O3Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.O3Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.O3Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.O3Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.O3Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.O3Pveinte);
