...
$(function () {
    const puno = localStorage.getItem("am02Puno");
    const pdos = localStorage.getItem("am02Pdos");
    const ptres = localStorage.getItem("am02Ptres");
    const pcuatro = localStorage.getItem("am02Pcuatro");
    const pcinco = localStorage.getItem("am02Pcinco");
    const pseis = localStorage.getItem("am02Pseis");
    const psiete = localStorage.getItem("am02Psiete");
    const pocho = localStorage.getItem("am02Pocho");
    const pnueve = localStorage.getItem("am02Pnueve");
    const pdiez = localStorage.getItem("am02Pdiez");
    const ponce = localStorage.getItem("am02Ponce");
    const pdoce = localStorage.getItem("am02Pdoce");
    const ptrece = localStorage.getItem("am02Ptrece");
    const pcatorce = localStorage.getItem("am02Pcatorce");
    const pquince = localStorage.getItem("am02Pquince");
    const pdieciseis = localStorage.getItem("am02Pdieciseis");
    const pdiecisiete = localStorage.getItem("am02Pdiecisiete");
    const pdieciocho = localStorage.getItem("am02Pdieciocho");
    const pdiecinueve = localStorage.getItem("am02Pdiecinueve");
    const pveinte = localStorage.getItem("am02Pveinte");
    const pveintiuno = localStorage.getItem("am02Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.am02Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.am02Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.am02Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.am02Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.am02Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.am02Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.am02Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.am02Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.am02Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.am02Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.am02Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.am02Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.am02Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.am02Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.am02Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.am02Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.am02Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.am02Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.am02Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.am02Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.am02Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.am02Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.am02Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.am02Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.am02Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.am02Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.am02Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.am02Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.am02Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.am02Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.am02Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.am02Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.am02Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.am02Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.am02Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.am02Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.am02Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.am02Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.am02Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.am02Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.am02Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.am02Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.am02Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.am02Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.am02Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.am02Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.am02Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.am02Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.am02Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.am02Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.am02Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.am02Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.am02Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.am02Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.am02Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.am02Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.am02Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.am02Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.am02Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.am02Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.am02Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.am02Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.am02Pveintiuno);
