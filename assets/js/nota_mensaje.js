...
$(function () {
    const puno = localStorage.getItem("enciende04Puno");
    const pdos = localStorage.getItem("enciende04Pdos");
    const ptres = localStorage.getItem("enciende04Ptres");
    const pcuatro = localStorage.getItem("enciende04Pcuatro");
    const pcinco = localStorage.getItem("enciende04Pcinco");
    const pseis = localStorage.getItem("enciende04Pseis");
    const psiete = localStorage.getItem("enciende04Psiete");
    const pocho = localStorage.getItem("enciende04Pocho");
    const pnueve = localStorage.getItem("enciende04Pnueve");
    const pdiez = localStorage.getItem("enciende04Pdiez");
    const ponce = localStorage.getItem("enciende04Ponce");
    const pdoce = localStorage.getItem("enciende04Pdoce");
    const ptrece = localStorage.getItem("enciende04Ptrece");
    const pcatorce = localStorage.getItem("enciende04Pcatorce");
    const pquince = localStorage.getItem("enciende04Pquince");
    const pdieciseis = localStorage.getItem("enciende04Pdieciseis");
    const pdiecisiete = localStorage.getItem("enciende04Pdiecisiete");
    const pdieciocho = localStorage.getItem("enciende04Pdieciocho");
    const pdiecinueve = localStorage.getItem("enciende04Pdiecinueve");
    const pveinte = localStorage.getItem("enciende04Pveinte");
    const pveintiuno = localStorage.getItem("enciende04Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.enciende04Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.enciende04Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.enciende04Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.enciende04Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.enciende04Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.enciende04Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.enciende04Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.enciende04Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.enciende04Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.enciende04Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.enciende04Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.enciende04Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.enciende04Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.enciende04Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.enciende04Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.enciende04Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.enciende04Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.enciende04Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.enciende04Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.enciende04Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.enciende04Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.enciende04Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.enciende04Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.enciende04Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.enciende04Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.enciende04Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.enciende04Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.enciende04Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.enciende04Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.enciende04Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.enciende04Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.enciende04Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.enciende04Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.enciende04Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.enciende04Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.enciende04Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.enciende04Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.enciende04Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.enciende04Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.enciende04Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.enciende04Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.enciende04Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.enciende04Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.enciende04Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.enciende04Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.enciende04Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.enciende04Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.enciende04Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.enciende04Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.enciende04Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.enciende04Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.enciende04Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.enciende04Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.enciende04Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.enciende04Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.enciende04Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.enciende04Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.enciende04Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.enciende04Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.enciende04Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.enciende04Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.enciende04Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.enciende04Pveintiuno);
