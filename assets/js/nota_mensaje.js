import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("Qqslles8Puno");
    const pdos = localStorage.getItem("Qqslles8Pdos");
    const ptres = localStorage.getItem("Qqslles8Ptres");
    const pcuatro = localStorage.getItem("Qqslles8Pcuatro");
    const pcinco = localStorage.getItem("Qqslles8Pcinco");
    const pseis = localStorage.getItem("Qqslles8Pseis");
    const psiete = localStorage.getItem("Qqslles8Psiete");
    const pocho = localStorage.getItem("Qqslles8Pocho");
    const pnueve = localStorage.getItem("Qqslles8Pnueve");
    const pdiez = localStorage.getItem("Qqslles8Pdiez");
    const ponce = localStorage.getItem("Qqslles8Ponce");
    const pdoce = localStorage.getItem("Qqslles8Pdoce");
    const ptrece = localStorage.getItem("Qqslles8Ptrece");
    const pcatorce = localStorage.getItem("Qqslles8Pcatorce");
    const pquince = localStorage.getItem("Qqslles8Pquince");
    const pdieciseis = localStorage.getItem("Qqslles8Pdieciseis");
    const pdiecisiete = localStorage.getItem("Qqslles8Pdiecisiete");
    const pdieciocho = localStorage.getItem("Qqslles8Pdieciocho");
    const pdiecinueve = localStorage.getItem("Qqslles8Pdiecinueve");
    const pveinte = localStorage.getItem("Qqslles8Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.Qqslles8Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.Qqslles8Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.Qqslles8Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.Qqslles8Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.Qqslles8Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.Qqslles8Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.Qqslles8Psiete))
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.Qqslles8Pocho))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.Qqslles8Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.Qqslles8Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.Qqslles8Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.Qqslles8Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.Qqslles8Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.Qqslles8Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.Qqslles8Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.Qqslles8Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.Qqslles8Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.Qqslles8Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.Qqslles8Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.Qqslles8Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.Qqslles8Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.Qqslles8Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.Qqslles8Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.Qqslles8Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.Qqslles8Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.Qqslles8Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.Qqslles8Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.Qqslles8Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.Qqslles8Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.Qqslles8Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.Qqslles8Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.Qqslles8Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.Qqslles8Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.Qqslles8Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.Qqslles8Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.Qqslles8Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.Qqslles8Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.Qqslles8Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.Qqslles8Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.Qqslles8Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.Qqslles8Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.Qqslles8Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.Qqslles8Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.Qqslles8Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.Qqslles8Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.Qqslles8Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.Qqslles8Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.Qqslles8Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.Qqslles8Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.Qqslles8Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.Qqslles8Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.Qqslles8Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.Qqslles8Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.Qqslles8Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.Qqslles8Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.Qqslles8Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.Qqslles8Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.Qqslles8Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.Qqslles8Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.Qqslles8Pveinte);
