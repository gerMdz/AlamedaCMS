...
$(function () {
    const puno = localStorage.getItem("excep07Puno");
    const pdos = localStorage.getItem("excep07Pdos");
    const ptres = localStorage.getItem("excep07Ptres");
    const pcuatro = localStorage.getItem("excep07Pcuatro");
    const pcinco = localStorage.getItem("excep07Pcinco");
    const pseis = localStorage.getItem("excep07Pseis");
    const psiete = localStorage.getItem("excep07Psiete");
    const pocho = localStorage.getItem("excep07Pocho");
    const pnueve = localStorage.getItem("excep07Pnueve");
    const pdiez = localStorage.getItem("excep07Pdiez");
    const ponce = localStorage.getItem("excep07Ponce");
    const pdoce = localStorage.getItem("excep07Pdoce");
    const ptrece = localStorage.getItem("excep07Ptrece");
    const pcatorce = localStorage.getItem("excep07Pcatorce");
    const pquince = localStorage.getItem("excep07Pquince");
    const pdieciseis = localStorage.getItem("excep07Pdieciseis");
    const pdiecisiete = localStorage.getItem("excep07Pdiecisiete");
    const pdieciocho = localStorage.getItem("excep07Pdieciocho");
    const pdiecinueve = localStorage.getItem("excep07Pdiecinueve");
    const pveinte = localStorage.getItem("excep07Pveinte");
    const pveintiuno = localStorage.getItem("excep07Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.excep07Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.excep07Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.excep07Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.excep07Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.excep07Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.excep07Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.excep07Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.excep07Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.excep07Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.excep07Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.excep07Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.excep07Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.excep07Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.excep07Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.excep07Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.excep07Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.excep07Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.excep07Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.excep07Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.excep07Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.excep07Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.excep07Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.excep07Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.excep07Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.excep07Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.excep07Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.excep07Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.excep07Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.excep07Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.excep07Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.excep07Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.excep07Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.excep07Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.excep07Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.excep07Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.excep07Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.excep07Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.excep07Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.excep07Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.excep07Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.excep07Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.excep07Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.excep07Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.excep07Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.excep07Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.excep07Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.excep07Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.excep07Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.excep07Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.excep07Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.excep07Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.excep07Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.excep07Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.excep07Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.excep07Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.excep07Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.excep07Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.excep07Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.excep07Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.excep07Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.excep07Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.excep07Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.excep07Pveintiuno);
