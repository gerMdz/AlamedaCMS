import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("SP3Puno");
    const pdos = localStorage.getItem("SP3Pdos");
    const ptres = localStorage.getItem("SP3Ptres");
    const pcuatro = localStorage.getItem("SP3Pcuatro");
    const pcinco = localStorage.getItem("SP3Pcinco");
    const pseis = localStorage.getItem("SP3Pseis");
    const psiete = localStorage.getItem("SP3Psiete");
    const pocho = localStorage.getItem("SP3Pocho");
    const pnueve = localStorage.getItem("SP3Pnueve");
    const pdiez = localStorage.getItem("SP3Pdiez");
    const ponce = localStorage.getItem("SP3Ponce");
    const pdoce = localStorage.getItem("SP3Pdoce");
    const ptrece = localStorage.getItem("SP3Ptrece");
    const pcatorce = localStorage.getItem("SP3Pcatorce");
    const pquince = localStorage.getItem("SP3Pquince");
    const pdieciseis = localStorage.getItem("SP3Pdieciseis");
    const pdiecisiete = localStorage.getItem("SP3Pdiecisiete");
    const pdieciocho = localStorage.getItem("SP3Pdieciocho");
    const pdiecinueve = localStorage.getItem("SP3Pdiecinueve");
    const pveinte = localStorage.getItem("SP3Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.SP3Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.SP3Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.SP3Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.SP3Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.SP3Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.SP3Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.SP3Psiete))
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.SP3Pocho))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.SP3Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.SP3Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.SP3Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.SP3Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.SP3Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.SP3Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.SP3Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.SP3Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.SP3Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.SP3Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.SP3Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.SP3Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.SP3Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.SP3Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.SP3Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.SP3Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.SP3Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.SP3Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.SP3Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.SP3Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.SP3Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.SP3Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.SP3Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.SP3Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.SP3Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.SP3Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.SP3Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.SP3Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.SP3Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.SP3Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.SP3Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.SP3Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.SP3Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.SP3Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.SP3Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.SP3Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.SP3Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.SP3Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.SP3Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.SP3Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.SP3Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.SP3Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.SP3Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.SP3Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.SP3Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.SP3Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.SP3Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.SP3Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.SP3Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.SP3Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.SP3Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.SP3Pveinte);
