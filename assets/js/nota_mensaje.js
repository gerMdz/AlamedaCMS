...
$(function () {
    const puno = localStorage.getItem("excep02Puno");
    const pdos = localStorage.getItem("excep02Pdos");
    const ptres = localStorage.getItem("excep02Ptres");
    const pcuatro = localStorage.getItem("excep02Pcuatro");
    const pcinco = localStorage.getItem("excep02Pcinco");
    const pseis = localStorage.getItem("excep02Pseis");
    const psiete = localStorage.getItem("excep02Psiete");
    const pocho = localStorage.getItem("excep02Pocho");
    const pnueve = localStorage.getItem("excep02Pnueve");
    const pdiez = localStorage.getItem("excep02Pdiez");
    const ponce = localStorage.getItem("excep02Ponce");
    const pdoce = localStorage.getItem("excep02Pdoce");
    const ptrece = localStorage.getItem("excep02Ptrece");
    const pcatorce = localStorage.getItem("excep02Pcatorce");
    const pquince = localStorage.getItem("excep02Pquince");
    const pdieciseis = localStorage.getItem("excep02Pdieciseis");
    const pdiecisiete = localStorage.getItem("excep02Pdiecisiete");
    const pdieciocho = localStorage.getItem("excep02Pdieciocho");
    const pdiecinueve = localStorage.getItem("excep02Pdiecinueve");
    const pveinte = localStorage.getItem("excep02Pveinte");
    const pveintiuno = localStorage.getItem("excep02Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.excep02Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.excep02Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.excep02Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.excep02Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.excep02Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.excep02Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.excep02Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.excep02Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.excep02Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.excep02Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.excep02Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.excep02Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.excep02Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.excep02Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.excep02Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.excep02Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.excep02Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.excep02Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.excep02Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.excep02Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.excep02Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.excep02Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.excep02Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.excep02Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.excep02Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.excep02Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.excep02Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.excep02Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.excep02Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.excep02Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.excep02Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.excep02Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.excep02Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.excep02Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.excep02Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.excep02Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.excep02Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.excep02Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.excep02Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.excep02Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.excep02Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.excep02Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.excep02Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.excep02Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.excep02Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.excep02Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.excep02Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.excep02Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.excep02Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.excep02Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.excep02Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.excep02Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.excep02Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.excep02Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.excep02Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.excep02Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.excep02Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.excep02Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.excep02Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.excep02Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.excep02Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.excep02Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.excep02Pveintiuno);
