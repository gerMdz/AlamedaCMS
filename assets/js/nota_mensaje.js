import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("UnAmor3Puno");
    const pdos = localStorage.getItem("UnAmor3Pdos");
    const ptres = localStorage.getItem("UnAmor3Ptres");
    const pcuatro = localStorage.getItem("UnAmor3Pcuatro");
    const pcinco = localStorage.getItem("UnAmor3Pcinco");
    const pseis = localStorage.getItem("UnAmor3Pseis");
    const psiete = localStorage.getItem("UnAmor3Psiete");
    const pocho = localStorage.getItem("UnAmor3Pocho");
    const pnueve = localStorage.getItem("UnAmor3Pnueve");
    const pdiez = localStorage.getItem("UnAmor3Pdiez");
    const ponce = localStorage.getItem("UnAmor3Ponce");
    const pdoce = localStorage.getItem("UnAmor3Pdoce");
    const ptrece = localStorage.getItem("UnAmor3Ptrece");
    const pcatorce = localStorage.getItem("UnAmor3Pcatorce");
    const pquince = localStorage.getItem("UnAmor3Pquince");
    const pdieciseis = localStorage.getItem("UnAmor3Pdieciseis");
    const pdiecisiete = localStorage.getItem("UnAmor3Pdiecisiete");
    const pdieciocho = localStorage.getItem("UnAmor3Pdieciocho");
    const pdiecinueve = localStorage.getItem("UnAmor3Pdiecinueve");
    const pveinte = localStorage.getItem("UnAmor3Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.UnAmor3Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.UnAmor3Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.UnAmor3Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.UnAmor3Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.UnAmor3Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.UnAmor3Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.UnAmor3Psiete))
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.UnAmor3Pocho))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.UnAmor3Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.UnAmor3Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.UnAmor3Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.UnAmor3Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.UnAmor3Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.UnAmor3Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.UnAmor3Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.UnAmor3Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.UnAmor3Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.UnAmor3Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.UnAmor3Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.UnAmor3Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.UnAmor3Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.UnAmor3Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.UnAmor3Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.UnAmor3Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.UnAmor3Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.UnAmor3Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.UnAmor3Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.UnAmor3Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.UnAmor3Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.UnAmor3Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.UnAmor3Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.UnAmor3Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.UnAmor3Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.UnAmor3Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.UnAmor3Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.UnAmor3Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.UnAmor3Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.UnAmor3Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.UnAmor3Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.UnAmor3Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.UnAmor3Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.UnAmor3Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.UnAmor3Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.UnAmor3Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.UnAmor3Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.UnAmor3Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.UnAmor3Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.UnAmor3Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.UnAmor3Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.UnAmor3Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.UnAmor3Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.UnAmor3Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.UnAmor3Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.UnAmor3Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.UnAmor3Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.UnAmor3Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.UnAmor3Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.UnAmor3Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.UnAmor3Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.UnAmor3Pveinte);
