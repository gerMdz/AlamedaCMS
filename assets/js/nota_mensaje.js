...
$(function () {
    const puno = localStorage.getItem("ra03Puno");
    const pdos = localStorage.getItem("ra03Pdos");
    const ptres = localStorage.getItem("ra03Ptres");
    const pcuatro = localStorage.getItem("ra03Pcuatro");
    const pcinco = localStorage.getItem("ra03Pcinco");
    const pseis = localStorage.getItem("ra03Pseis");
    const psiete = localStorage.getItem("ra03Psiete");
    const pocho = localStorage.getItem("ra03Pocho");
    const pnueve = localStorage.getItem("ra03Pnueve");
    const pdiez = localStorage.getItem("ra03Pdiez");
    const ponce = localStorage.getItem("ra03Ponce");
    const pdoce = localStorage.getItem("ra03Pdoce");
    const ptrece = localStorage.getItem("ra03Ptrece");
    const pcatorce = localStorage.getItem("ra03Pcatorce");
    const pquince = localStorage.getItem("ra03Pquince");
    const pdieciseis = localStorage.getItem("ra03Pdieciseis");
    const pdiecisiete = localStorage.getItem("ra03Pdiecisiete");
    const pdieciocho = localStorage.getItem("ra03Pdieciocho");
    const pdiecinueve = localStorage.getItem("ra03Pdiecinueve");
    const pveinte = localStorage.getItem("ra03Pveinte");
    const pveintiuno = localStorage.getItem("ra03Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.ra03Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.ra03Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.ra03Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.ra03Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.ra03Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.ra03Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.ra03Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.ra03Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.ra03Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.ra03Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.ra03Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.ra03Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.ra03Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.ra03Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.ra03Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.ra03Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.ra03Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.ra03Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.ra03Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.ra03Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.ra03Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.ra03Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.ra03Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.ra03Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.ra03Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.ra03Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.ra03Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.ra03Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.ra03Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.ra03Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.ra03Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.ra03Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.ra03Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.ra03Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.ra03Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.ra03Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.ra03Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.ra03Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.ra03Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.ra03Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.ra03Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.ra03Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.ra03Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.ra03Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.ra03Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.ra03Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.ra03Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.ra03Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.ra03Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.ra03Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.ra03Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.ra03Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.ra03Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.ra03Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.ra03Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.ra03Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.ra03Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.ra03Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.ra03Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.ra03Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.ra03Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.ra03Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.ra03Pveintiuno);
