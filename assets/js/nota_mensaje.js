...
$(function () {
    ...
    const pcuatro = localStorage.getItem("excep05Pcuatro");
    const pcinco = localStorage.getItem("excep05Pcinco");
    const pseis = localStorage.getItem("excep05Pseis");
    const psiete = localStorage.getItem("excep05Psiete");
    const pocho = localStorage.getItem("excep05Pocho");
    const pnueve = localStorage.getItem("excep05Pnueve");
    const pdiez = localStorage.getItem("excep05Pdiez");
    const ponce = localStorage.getItem("excep05Ponce");
    const pdoce = localStorage.getItem("excep05Pdoce");
    const ptrece = localStorage.getItem("excep05Ptrece");
    const pcatorce = localStorage.getItem("excep05Pcatorce");
    const pquince = localStorage.getItem("excep05Pquince");
    const pdieciseis = localStorage.getItem("excep05Pdieciseis");
    const pdiecisiete = localStorage.getItem("excep05Pdiecisiete");
    const pdieciocho = localStorage.getItem("excep05Pdieciocho");
    const pdiecinueve = localStorage.getItem("excep05Pdiecinueve");
    const pveinte = localStorage.getItem("excep05Pveinte");
    const pveintiuno = localStorage.getItem("excep05Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.excep05Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.excep05Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.excep05Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.excep05Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.excep05Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.excep05Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.excep05Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.excep05Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.excep05Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.excep05Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.excep05Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.excep05Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.excep05Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.excep05Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.excep05Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.excep05Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.excep05Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.excep05Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.excep05Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.excep05Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.excep05Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.excep05Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.excep05Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.excep05Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.excep05Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.excep05Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.excep05Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.excep05Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.excep05Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.excep05Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.excep05Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.excep05Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.excep05Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.excep05Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.excep05Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.excep05Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.excep05Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.excep05Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.excep05Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.excep05Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.excep05Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.excep05Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.excep05Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.excep05Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.excep05Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.excep05Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.excep05Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.excep05Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.excep05Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.excep05Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.excep05Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.excep05Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.excep05Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.excep05Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.excep05Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.excep05Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.excep05Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.excep05Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.excep05Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.excep05Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.excep05Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.excep05Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.excep05Pveintiuno);
