import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("detox01Puno");
    const pdos = localStorage.getItem("detox01Pdos");
    const ptres = localStorage.getItem("detox01Ptres");
    const pcuatro = localStorage.getItem("detox01Pcuatro");
    const pcinco = localStorage.getItem("detox01Pcinco");
    const pseis = localStorage.getItem("detox01Pseis");
    const psiete = localStorage.getItem("detox01Psiete");
    const pocho = localStorage.getItem("detox01Pocho");
    const pnueve = localStorage.getItem("detox01Pnueve");
    const pdiez = localStorage.getItem("detox01Pdiez");
    const ponce = localStorage.getItem("detox01Ponce");
    const pdoce = localStorage.getItem("detox01Pdoce");
    const ptrece = localStorage.getItem("detox01Ptrece");
    const pcatorce = localStorage.getItem("detox01Pcatorce");
    const pquince = localStorage.getItem("detox01Pquince");
    const pdieciseis = localStorage.getItem("detox01Pdieciseis");
    const pdiecisiete = localStorage.getItem("detox01Pdiecisiete");
    const pdieciocho = localStorage.getItem("detox01Pdieciocho");
    const pdiecinueve = localStorage.getItem("detox01Pdiecinueve");
    const pveinte = localStorage.getItem("detox01Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.detox01Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.detox01Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.detox01Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.detox01Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.detox01Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.detox01Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.detox01Psiete))
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.detox01Pocho))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.detox01Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.detox01Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.detox01Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.detox01Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.detox01Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.detox01Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.detox01Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.detox01Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.detox01Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.detox01Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.detox01Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.detox01Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.detox01Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.detox01Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.detox01Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.detox01Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.detox01Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.detox01Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.detox01Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.detox01Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.detox01Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.detox01Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.detox01Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.detox01Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.detox01Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.detox01Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.detox01Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.detox01Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.detox01Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.detox01Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.detox01Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.detox01Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.detox01Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.detox01Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.detox01Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.detox01Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.detox01Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.detox01Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.detox01Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.detox01Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.detox01Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.detox01Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.detox01Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.detox01Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.detox01Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.detox01Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.detox01Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.detox01Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.detox01Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.detox01Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.detox01Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.detox01Pveinte);
