import $ from 'jquery';
$(function () {
    const puno = localStorage.getItem("UnAmor2Puno");
    const pdos = localStorage.getItem("UnAmor2Pdos");
    const ptres = localStorage.getItem("UnAmor2Ptres");
    const pcuatro = localStorage.getItem("UnAmor2Pcuatro");
    const pcinco = localStorage.getItem("UnAmor2Pcinco");
    const pseis = localStorage.getItem("UnAmor2Pseis");
    const psiete = localStorage.getItem("UnAmor2Psiete");
    const pocho = localStorage.getItem("UnAmor2Pocho");
    const pnueve = localStorage.getItem("UnAmor2Pnueve");
    const pdiez = localStorage.getItem("UnAmor2Pdiez");
    const ponce = localStorage.getItem("UnAmor2Ponce");
    const pdoce = localStorage.getItem("UnAmor2Pdoce");
    const ptrece = localStorage.getItem("UnAmor2Ptrece");
    const pcatorce = localStorage.getItem("UnAmor2Pcatorce");
    const pquince = localStorage.getItem("UnAmor2Pquince");
    const pdieciseis = localStorage.getItem("UnAmor2Pdieciseis");
    const pdiecisiete = localStorage.getItem("UnAmor2Pdiecisiete");
    const pdieciocho = localStorage.getItem("UnAmor2Pdieciocho");
    const pdiecinueve = localStorage.getItem("UnAmor2Pdiecinueve");
    const pveinte = localStorage.getItem("UnAmor2Pveinte");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.UnAmor2Pcinco))
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.UnAmor2Puno))
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.UnAmor2Pdos))
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.UnAmor2Ptres))
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.UnAmor2Pcuatro))
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.UnAmor2Pseis))
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.UnAmor2Psiete))
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.UnAmor2Pocho))
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.UnAmor2Pnueve))
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.UnAmor2Pdiez))
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.UnAmor2Ponce))
...
if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.UnAmor2Pdoce))
...
if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.UnAmor2Ptrece))
...
if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.UnAmor2Pcatorce))
...
if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.UnAmor2Pquince))
...
if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.UnAmor2Pdieciseis))
...
if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.UnAmor2Pdiecisiete))
...
if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.UnAmor2Pdieciocho))
...
if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.UnAmor2Pdiecinueve))
...
if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.UnAmor2Pveinte))
...
function procesa(p) {
    ...
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.UnAmor2Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.UnAmor2Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.UnAmor2Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.UnAmor2Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.UnAmor2Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.UnAmor2Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.UnAmor2Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.UnAmor2Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.UnAmor2Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.UnAmor2Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.UnAmor2Ponce = JSON.stringify(ponce);
    }
    
    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.UnAmor2Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.UnAmor2Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.UnAmor2Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.UnAmor2Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.UnAmor2Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.UnAmor2Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.UnAmor2Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.UnAmor2Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.UnAmor2Pveinte = JSON.stringify(pveinte);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.UnAmor2Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.UnAmor2Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.UnAmor2Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.UnAmor2Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.UnAmor2Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.UnAmor2Puno);
    ...
    if (p === 'cinco') {
        ...
        const pcinco = JSON.parse(localStorage.UnAmor2Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.UnAmor2Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.UnAmor2Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.UnAmor2Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.UnAmor2Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.UnAmor2Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.UnAmor2Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.UnAmor2Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.UnAmor2Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.UnAmor2Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.UnAmor2Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.UnAmor2Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.UnAmor2Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.UnAmor2Pveinte);
