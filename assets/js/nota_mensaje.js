...
$(function () {
    const puno = localStorage.getItem("enciende03Puno");
    const pdos = localStorage.getItem("enciende03Pdos");
    const ptres = localStorage.getItem("enciende03Ptres");
    const pcuatro = localStorage.getItem("enciende03Pcuatro");
    const pcinco = localStorage.getItem("enciende03Pcinco");
    const pseis = localStorage.getItem("enciende03Pseis");
    const psiete = localStorage.getItem("enciende03Psiete");
    const pocho = localStorage.getItem("enciende03Pocho");
    const pnueve = localStorage.getItem("enciende03Pnueve");
    const pdiez = localStorage.getItem("enciende03Pdiez");
    const ponce = localStorage.getItem("enciende03Ponce");
    const pdoce = localStorage.getItem("enciende03Pdoce");
    const ptrece = localStorage.getItem("enciende03Ptrece");
    const pcatorce = localStorage.getItem("enciende03Pcatorce");
    const pquince = localStorage.getItem("enciende03Pquince");
    const pdieciseis = localStorage.getItem("enciende03Pdieciseis");
    const pdiecisiete = localStorage.getItem("enciende03Pdiecisiete");
    const pdieciocho = localStorage.getItem("enciende03Pdieciocho");
    const pdiecinueve = localStorage.getItem("enciende03Pdiecinueve");
    const pveinte = localStorage.getItem("enciende03Pveinte");
    const pveintiuno = localStorage.getItem("enciende03Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.enciende03Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.enciende03Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.enciende03Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.enciende03Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.enciende03Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.enciende03Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.enciende03Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.enciende03Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.enciende03Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.enciende03Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.enciende03Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.enciende03Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.enciende03Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.enciende03Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.enciende03Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.enciende03Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.enciende03Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.enciende03Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.enciende03Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.enciende03Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.enciende03Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.enciende03Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.enciende03Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.enciende03Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.enciende03Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.enciende03Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.enciende03Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.enciende03Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.enciende03Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.enciende03Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.enciende03Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.enciende03Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.enciende03Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.enciende03Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.enciende03Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.enciende03Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.enciende03Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.enciende03Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.enciende03Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.enciende03Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.enciende03Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.enciende03Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.enciende03Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.enciende03Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.enciende03Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.enciende03Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.enciende03Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.enciende03Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.enciende03Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.enciende03Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.enciende03Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.enciende03Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.enciende03Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.enciende03Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.enciende03Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.enciende03Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.enciende03Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.enciende03Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.enciende03Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.enciende03Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.enciende03Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.enciende03Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.enciende03Pveintiuno);
