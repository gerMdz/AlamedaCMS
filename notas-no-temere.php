    ...
    <div class="row">
      <div class="col-md-4 mb-5">
        <div class="card h-100">
          <div class="card-body">
            <h2 class="card-title greatlakes">No temeré</h2>
      ...
      <!-- /.col-md-4 -->
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                <div class="card-body">
                    <h2 class="card-title greatlakes">Encerrados</h2>
...
<div class="col-md-4 mb-5 mx-auto">
            <div class="card h-100">
                <div class="card-body">
                    <h2 class="card-title">Jesús en Vivo</h2>
                    <img src="series/no-temere/04-Jesus-en-vivo.jpg" class="img-fluid" />
  ...
  <footer class="footer">
      <div class="card-body">
          <h4 class="text-darker card-text text-center">
              <a href="notas.php" class="btn btn-xl btn-alameda">
                  Ver Serie Actual
              </a>
            </h4>
      </div>
