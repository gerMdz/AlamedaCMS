...
<body id="page-top" class="frontal">
...
<!-- Header -->
<header class="masthead_ja fondo-evento">
    <div class="container">
        <div class="intro-text sombra">
            <div class="intro-lead-in">Hola!, has llegado a Jóvenes de la Alameda,
                aunque nos justaría que nos conocieras como </div>
            <div class="intro-heading text-uppercase"> JA!</div>
            <h5>
