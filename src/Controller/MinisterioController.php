...
class MinisterioController extends AbstractController
{
    ...
    /**
     * @Route("/{id}", name="ministerio_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="ministerio_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="ministerio_delete", methods={"DELETE"})
     */
