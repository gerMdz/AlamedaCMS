...
#[\Symfony\Component\Routing\Attribute\Route(path: '/admin/roles')]
class RolesController extends AbstractController
{
    #[\Symfony\Component\Routing\Attribute\Route(path: '/', name: 'roles_list', methods: ['GET'])]
    ...
    #[\Symfony\Component\Routing\Attribute\Route(path: '/new', name: 'roles_new', methods: ['GET', 'POST'])]
    ...
    #[\Symfony\Component\Routing\Attribute\Route(path: '/{id}', name: 'roles_show', methods: ['GET'])]
    ...
    #[\Symfony\Component\Routing\Attribute\Route(path: '/{id}/edit', name: 'roles_edit', methods: ['GET', 'POST'])]
    ...
    #[\Symfony\Component\Routing\Attribute\Route(path: '/{id}', name: 'roles_delete', methods: ['DELETE'])]
