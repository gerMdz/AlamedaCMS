			...
			<div class="container">
				<div class="row fullscreen align-items-center justify-content-center">
					<div class="banner-left col-lg-6">
						<img class="d-flex mx-auto img-fluid" src="../imagenes/series/bondad/bondad_02.jpg" alt="Bondad">
					</div>
					<div class="col-lg-6">
...
<!--                                <span class="text-realce"> 7 de Octubre</span><br>-->
							11 hs. y 19 hs. <br/>
                                <span class="text-realce-rojo"> Auditorio Alameda </span></h1>
							<a href="#" class="btn-generico rojo circular ">
		...
		<section class="section bg-rojo_claro p-5 mdl-color-text--black" id="section-rojo">
			<div class="container">
                <div class="row fullscreen align-items-center justify-content-center ">
                <div class="row align-items-center bg-white ">
                    <div class="col-lg-8">
                        <div class="story-content">
                            <h2 class="pt-2 " style="font-family: joyful; font-size: 5em">
                                ¿Qué ambiente respirás?
                            </h2><br/>

                            <i class="fab fa-soundcloud fa-3x rounded-0 img-responsive"></i>
                            <p class="mt-0 ml-5 pl-5 text-invitacion ">
                                Como nubes que oscurecen el cielo las circunstancias de tu vida,
                                las personas que te rodean y el ambiente en la calle,
                                parece todo complotarse para robarte la alegría, robarte el futuro
                                y dejarte en un ambiente donde lo que se respira es pesimismo e
                                irritación.
                            </p>
                            <i class="fas fa-exclamation fa-3x rounded-0 img-responsive"></i>
                            <p class="mt-0 ml-5 pl-5 base-rojo text-invitacion">
                                Esta es la buena noticia: ¡No tenés porqué seguir viviendo allí!

                                 </p>

                            <i class="fas fa-road fa-3x rounded-0 img-responsive"></i>
                            <p class="mt-0 ml-5 pl-5 base-rojo text-invitacion ">
                                Hay un camino de resistencia, de lucidez y de valentía para quienes no
                                están dispuestos a conformarse:
                            </p>
                            <i class="fas fa-sun fa-3x rounded-0 img-responsive"></i>
                            <p class="mt-0 ml-5 pl-5 base-rojo text-invitacion">
                                <i><b>¡Hay bondad!, ¡Una bondad que mereces descubrir!</b></i>
                            ...
                            <p class="mt-0 ml-5 pl-5 base-rojo text-invitacion">
                                ...
                                Este será el viaje que comenzaremos a partir del
                                <i>Domingo 21 de abril</i>, en dos oportunidades <i>11hs y 19hs.</i>
                    ...
                    <div class="col-lg-4">
                        <img class="img-fluid d-flex mx-auto mt-5" src="../imagenes/series/bondad/VOLANTE-DE-MANO-BONDAD.jpg" alt="Bondad">
