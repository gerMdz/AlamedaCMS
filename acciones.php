...
<!--    </nav>-->
    ...
    <header class="masthead text-white text-center ">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto fondo-medio text-white-75">
            <h4 class="mb-5">¡Bienvenido a La Alameda!<br />
                Creemos que Dios tiene un plan maravilloso para tu vida.<br/>
                Nuestro profundo deseo es ayudarte a comenzar una relación con Dios y
                así crecer de tal manera que alcances la verdadera felicidad para vos y tu hogar.<br/>
                Estamos listos para oir tus sueños y acompañarte a través de las etapas de la vida.
                Sabemos que sos importante para Dios.<br/>
                "No deseamos simplemente verte llenar un banco en la iglesia, mas bien deseamos verte llenar tu vida con próposito"
            </h4>
          </div>
